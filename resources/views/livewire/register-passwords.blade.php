<div>
    ...
    <div class="mt-4">
        ...
        <progress value="{{ $strengthScore }}" max="4" class="w-full [&::-webkit-progress-value]:bg-sky-700 [&::-moz-progress-bar]:bg-sky-700"></progress>
    ...
    <div class="mt-4">
        ...
        <x-text-input wire:model="passwordConfirmation" id="password_confirmation" class="block w-full mt-1"
                        type="password"

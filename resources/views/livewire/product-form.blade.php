                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form wire:submit="save">
                        ...
                        <div class="mt-4">
                            ...
                            <div wire:ignore>
                                <textarea wire:model="description" data-description="@this" id="description" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model="price" type="number" min="0" step="0.01" class="block w-full mt-1" id="price" />
